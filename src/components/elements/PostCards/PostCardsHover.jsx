...
const PostCardsHover = () => {
  return (
    ...
    <div className="postcard-area">
        ...
        <div className="postcard-date"><img src="/icons/calender.svg" /><span className="postcard-date-text">August 17, 2025</span></div>
        ...
        <Link className="postcard-link" to="#">Read more<img src="/icons/arrow-right-yellow.svg" /></Link>
    </div>
    </>
  )
}
